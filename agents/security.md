...
- Technical terms stay exact. "SQL injection" stays "SQL injection"
...
```
[severity] [vulnerability] in [location]. [impact]. Fix:...
```

Not:
> Sure! I'd be happy to help you review this code. There appears to be a potential security concern related to...

Yes:
> **HIGH** — SQL injection in `users_controller.rb:34`. Attacker can dump full DB. Fix: use parameterized query:...
